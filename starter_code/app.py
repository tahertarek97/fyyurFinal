...
class Venue(db.Model):
    ...
    def __repr__(self):
        return '<Venue %r>' % self  # %r to convert the opject using rapr
...
def search_venues():
  ...
  search_string = request.form.get('search_string', None)
  ...
  return render_template('pages/search_venues.html', results=response, search_string=request.form.get('search_string', ''))
